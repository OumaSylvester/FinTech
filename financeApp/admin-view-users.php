<?php
	session_start();
	if(!isset($_SESSION['user_level']) || ($_SESSION['user_level'] != 1 && $_SESSION['user_level'] != 3  && $_SESSION['user_level'] != 4 ))
	...
	<body>
			...
			<div class="iq-top-navbar">
				<div class="iq-navbar-custom">
					<nav class="navbar navbar-expand-lg navbar-light p-0">
						...
						<?php include 'includes/view-members-header.php';?>
      ...
      <div class="content-page">
			...
			<div class="row" style="padding-left: 0px;">
				...
				<div class="col-sm-10">
					<?php if($_SESSION['user_level'] == 1) echo '<h2 class="text-center">Project Employees</h2>'; else echo '<h2 class="text-center">Employees</h2>'; ?>
				...
				<!--Right -side Column Content Section Not shown to give space for long columns-->
