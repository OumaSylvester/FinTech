<?php
	...
	if(isset($_GET['pid'])){
		$_SESSION['pid_add_task'] = $_GET['pid'];
	}else{
			...
			<div class="iq-top-navbar">
				<div class="iq-navbar-custom">
					<nav class="navbar navbar-expand-lg navbar-light p-0">
						...
						<?php include 'includes/add-task-header.php';?>
			...
			<div class="row" style="padding: 0px;">
				...
				<?php 
					if($_SERVER['REQUEST_METHOD'] == 'POST'){
						require 'process-add-task.php';
						//End of the main Submit conditional
					}
				?>
				<div class="col-sm-10">
					<h2 class="h2 text-center">Add Task</h2>
					<form action="add-task.php" method="post" name="add_project" id="add_project">
                        <!-- <input type="hidden" value="<?php //$_GET['pid'] ?>"> -->
						<div class="form-group row">
							<label for="project_name" class="col-sm-4 col-form-label">Task Name:</label>
							<div class="col-sm-8">
								<input type="text" name="task_name" id="task_name" class="form-control" placeholder="Name of task" maxlength="60" required value="<?php if(isset($_POST['task_name'])) echo $_POST['task_name']; ?>">
							</div>
						</div>

						<div class="form-group row">
							<label for="project_class" class="col-sm-4 col-form-label">Task Description:</label>
							<div class="col-sm-8">
								<textarea type="text" name="task_desc" id="task_desc" class="form-control" required maxlength="250" placeholder="Task details" value="<?php if(isset($_POST['task_desc'])) echo $_POST['task_desc']; ?>"></textarea>
							</div>
						</div>
