<?php
    ...
    if(!isset($_SESSION['user_level']) || $_SESSION['user_level'] == 2){  
        //user not logged in or user not project employee, finance manager, owner or project manager. finance employee cannot view the assignements
...
<html>
    ...
    <body>
						...
						<ul id="iq-sidebar-toggle" class="iq-menu">
							<li class="active">
                                ...
                                <ul id="dashboard" class="iq-submenu collapse show" data-parent="#iq-sidebar-toggle">
                                 ...
                                 <?php if($_SESSION['user_level'] == 0) include 'includes/members-nav.php'; else include 'includes/nav.php' ;?>
                            </ul>
								</ul>
							</li>
						</ul>
			...
			<div class="iq-top-navbar">
				<div class="iq-navbar-custom">
					<nav class="navbar navbar-expand-lg navbar-light p-0">
						...
						<?php include 'includes/view-assignment-header.php';?>
      ...
      <div class="content-page">
                ...
                <div class="col-sm-10">
                    <?php if($_SESSION['user_level'] == 0) echo '<h2 class="h2 text-center">You have been assigned to the following project(s): </h2>';
                    else echo '<h2 class="h2 text-center">Work Assignment: </h2>' ?>
                    
                    <p>
                        <?php require 'process-view-assignment.php'; ?>
                    </p> 
