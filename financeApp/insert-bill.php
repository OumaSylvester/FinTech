			...
			<div class="iq-top-navbar">
				<div class="iq-navbar-custom">
					<nav class="navbar navbar-expand-lg navbar-light p-0">
						...
						<?php include 'includes/insert-bill-header.php';?>
      ...
      <div class="content-page">
				...
				<?php 
					if($_SERVER['REQUEST_METHOD'] == 'POST'){
						require 'process-insert-bill.php';
						//End of the main Submit conditional
					}
				?>
				<div class="col-sm-10">
					<h2 class="h2 text-center">Insert Bill</h2>
					<form enctype="multipart/form-data" action="insert-bill.php" method="post" name="add_project" id="add_project">
						<!-- <input type="hidden" name="MAX_FILE_SIZE" value="1024000"> -->
						<div class="form-group row">
							<label for="image" class="col-sm-4 col-form-label">Select a Bill Image:</label>
							<div class="col-sm-8">
								<input type="file" name="image" id="image" class="form-control" placeholder="Choose Bill Image"  required value="<?php if(isset($_FILES['image'])) echo $_FILES['image'] ?>">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" name="price" id="price" class="form-control" required maxlength="12" placeholder="$"  pattern="[0-9]{1,3}[,]?[0-9]*[.]?[0-9]*"  title="Enter valid Currency. Onlu numbers, comma and fullstop"  value="<?php if(isset($_POST['price'])) echo $_POST['price'] ?>">
															</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8" style="margin-top: 8px;">
								<input type="submit" name="submit" id="submit" class="btn btn-primary" value="Insert Bill">
							</div>
						</div>
