<?php
    ...
    if(!isset($_SESSION['user_level']) || ($_SESSION['user_level'] != 1 && $_SESSION['user_level'] != 3 && $_SESSION['user_level'] != 4)){
        //user not logged in or use not project manager, finance manager or owner
...
<html>
    ...
    <body>
      ...
      <div class="content-page">
                ...
                <div class="col-sm-10">
                    <h2 class="text-center"> These are the current Projects</h2>
                    <p>
                        <?php 
                        if($_SESSION['user_level'] == 1){
                            require 'process-view-projects.php';
                        }else{
                            require 'process-finance-man-view-projects.php';
                        }
