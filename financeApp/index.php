		...
		<div class="Wrapper" style="margin-top: 30px;">
			...
			<div class="content-page">
				<div class="container-fluid">
					<div class="row">
						<div class="col-sm-10">
							<h2 class="text-center">Finance application landing page</h2>
							<p>When it comes tp finance. We are the best
								in the country.<br>Explore our site.<br>Add Content for the footer to be down the page.
							</p>
						</div>
