        ...
        if($result){
            ...
            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                ...
                if(isset($_SESSION['eid'])){
                    ...
                    <td><a href="#">Edit</td>
                    <td><a href="#">Delete</td>
                    <td><a href="add-task.php?pid=' . $project_id . '">Add Task</td>
                    <td><a href="view-task.php?pid=' . $project_id . '">View Tasks</td>
                   
                    <td><a href="assign-work.php?pid=' . $project_id . '">Choose</a></td> 
                    <td>
                    '. $project_name . '</td>
                    <td>
                    ' . $project_class . '</td>
