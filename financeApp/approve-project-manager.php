<?php
    ...
    if(!isset($_SESSION['user_level']) || $_SESSION['user_level'] != 3){
        //user not logged in or use not project manager
...
<html>
    ...
    <body>
			...
			<div class="iq-top-navbar">
				<div class="iq-navbar-custom">
					<nav class="navbar navbar-expand-lg navbar-light p-0">
						...
						<?php include 'includes/approve-project-manager-header.php';?>
      ...
      <div class="content-page">
                ...
                <div class="col-sm-10">
                    <h2 class="text-center">Choose Project Manager to Approve</h2>
                    <p>
                        <?php require 'process-view-project-managers.php'; ?>
                    </p> 
